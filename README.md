<h1 align="center">Hey, I'm Shahzai </h1> 
...
* 🏠 **Rent Management System (RMS)** — Own end-to-end modules for Policy, Vendor, Owner, Insurer, Bus, and Fixed Asset management, including the full Fixed Asset lifecycle (add, edit, report, role-based access, audit logging) and a Chart.js analytics dashboard. Designed the ANF Uniform Request workflow — multi-item transactional submissions, approval routing, and automated email notifications.
* 📊 **Enterprise Performance Management (EPM)** — Build and maintain daily operational reporting across Finance, Urban, FastEx, Fueling, and EBS business units, with duplicate-submission safeguards, multi-table transactional integrity (SqlTransaction), session-based security, and per-module history/report views.
* 🚍 **Daewoo Express Corporate Website** — Delivered the Terminal Locations feature (dynamic JSON-driven data), authored FAQ content, and led a full UAT review that surfaced and documented key launch-blocking defects before go-live.
### 🕰️ Previously at Nova Soft Tech
 
Delivered 5+ production-level applications across the .NET and MERN ecosystems:
 
* 🛒 **E-Commerce Platform** — N-Tier architecture, Repository Pattern, Unit of Work, ASP.NET Core Identity, AJAX search, and role-based authorization.
* 🏦 **Banking & Payroll System** — Secure transaction processing with JWT authentication, role-based access, and automated payroll calculations.
...
<table>
  <tr>
    <td width="50%">
      <h3>🏠 Rent Management System (RMS)</h3>
      <p> Enterprise rental operations platform covering Policy, Vendor, Owner, Insurer, Bus, and Fixed Asset management, with role-based dashboards, audit logging, and automated workflow notifications.
      </p>
      <p><b>ASP.NET Core MVC • C# • ADO.NET • SQL Server • Chart.js</b></p>
    </td>
    <td width="50%">
      <h3>📊 Enterprise Performance Management (EPM)</h3>
      <p> Enterprise performance platform for monitoring departmental KPIs,
        metrics, dashboards, daily feeds, and operational reports across five business units.
      </p>
